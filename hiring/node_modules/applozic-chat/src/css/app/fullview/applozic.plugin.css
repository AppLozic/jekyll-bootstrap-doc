...
body {
	...
	font-weight: 400;
	background-image: url("https://www.applozic.com/resources/images/careers.png");
...
.mck-container .left .people .person .mck-icon-user, .mck-container .left .people .person.active .mck-icon-user,
	.mck-container .left .people .person:hover .mck-icon-user, .mck-group-search-list .mck-icon-user, .mck-contact-search-list .mck-icon-user, .mck-group-member-list .mck-icon-user {
	background: url(../../../images/mck-plugin-sprite.png);
...
.mck-container .right .bubble.mck-msg-right .mck-msg-box {
	float: right;
	color: #fff;
	font-size: 14px;
	margin-right: 15px;
...
.mck-container .right .mck-group-inner .bubble.mck-msg-left .mck-msg-box
	{
	padding: 4px 8px;
	color: #333;
	background: #fff;
...
.mck-container .right .mck-group-inner .bubble.mck-msg-left .mck-msg-box:after
	{
	border-right-color: #fff;
}

.mck-container .right .bubble.mck-msg-left .mck-msg-box {
	float: left;
	color: #1a1a1a;
	font-size: 14px;
	margin-left: 15px;
