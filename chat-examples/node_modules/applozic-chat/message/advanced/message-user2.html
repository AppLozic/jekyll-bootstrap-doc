...
<body>
							...
							<div class="mck-row">
								<div class="blk-lg-2 move-right">
									<div class="mck-dropdown-toggle" data-toggle="mckdropdown"
										aria-expanded="true">
										<img
											src="css/app/images/mck-icon-menu.png"
											alt="Tab Menu">
									</div>
				...
				<div id="mck-sidebox-search"
					...
					<div class="mck-box-top">
						...
						<div
							...
							<div class="mck-dropdown-toggle" data-toggle="mckdropdown"
								aria-expanded="true">
								<img src="css/app/images/icon-menu.png"
									alt="Tab Menu">
							</div>
						...
						<div class="mck-group-md-sec">
							...
							<div id="mck-group-add-member-box"
								...
								<a id="mck-group-add-member" class="mck-group-add-member"
									...
									<div class="blk-lg-3">
										<img
											src="css/app/images/mck-icon-add-member.png"
											alt="Add Member">
									</div>
	...
	<script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $applozic.fn.applozic({userId: 'customer-2', userName: 'Customer2', appId: 'applozic-sample-app',
                    ojq: $original,
                    obsm: oModal,
