...
.mck-sidebox-search .mck-box-top {
	padding-right: 0;
}

.mck-group-search-box .mck-box-top .blk-lg-3 {
	width: 30px;
	height: inherit;
	padding: 14px 0;
}

.mck-group-search-box .mck-box-top .blk-lg-7, .mck-sidebox-search .mck-box-top .blk-lg-5
	{
	width: 230px
}
...
.mck-group-search-box .mck-box-body {
	padding: 10px;
}
...
.mck-group-search-box .mck-box-body .mck-tab-cell {
	height: 300px;
}
...
.mck-group-search-box .mck-box-body .mck-message-inner {
	height: 300px;
	background-color: #fff;
}
...
.mck-contact-list .mck-alpha-contact-image {
	border-radius: 110px;
}
...
.mck-group-add-member-box img, .mck-group-search-box .mck-box-top .blk-lg-3 img
	{
	width: 20px;
	height: 20px;
	display: block;
...
@media ( min-width : 310px) {
	...
	.mck-group-search-list .blk-lg-9 {
		width: 190px
	}
	.blk-lg-12 {
		width: 100%;
