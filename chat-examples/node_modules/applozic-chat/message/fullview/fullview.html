...
<link href="autosuggest/css/jquery.atwho.min.css" rel="stylesheet">
					...
					<div class="mck-box-top mck-row mck-wt-user-icon">
						...
						<div class="blk-lg-2 move-right mck-menu-item mck-text-right">
								<div class="mck-dropdown-toggle" data-toggle="mckdropdown"
										aria-expanded="true">
										<img
								src="css/app/images/icon-menu.png" class="mck-menu-icon" alt="Menu">
									</div>
									<ul id="mck-start-new-menu-box"
										class="mck-dropdown-menu mck-tab-menu-box menu-right"
										role="menu">
										<li><a href="#"
											class="mck-contact-search menu-item"
											title="New Chat">New Chat</a></li>
										<li><a href="#"
											class="mck-contact-search menu-item"
											title="Contacts">Contacts</a></li>
										<li><a href="#"
											class="mck-group-search menu-item"
											title="Groups">Groups</a></li>
										<li><a href="#"
											id="mck-new-group" class="menu-item" title="Create Group">Create 
												Group</a></li>
									</ul>
						</div>
					</div>
					...
					<div class="mck-panel-body">
						<div id="mck-contact-cell" class="mck-panel-cell">
							...
							<div id="mck-contact-loading" class="mck-loading">
								<img src="css/app/images/ring.gif">
							</div>
				...
				<div class="panel-content">
					<div id="mck-tab-header" class="mck-box-top n-vis">
						<div id="mck-tab-individual"
							class="mck-tab-individual mck-row">
								...
								<div id="mck-tab-menu" class="mck-menu-item mck-text-right">
									...
									<ul id="mck-tab-menu-list"
										...
										<li id="li-mck-group-info"
											...
											id="mck-group-info-btn" class="menu-item mck-group-info-btn"
							...
							<div id="mck-group-create-panel"
									...
									<div id="mck-group-create-icon-box"
										...
										<span class="mck-overlay-box">
											...
											<div id="mck-group-create-icon-loading"
												...
												<img
													src="css/app/images/mck-loading.gif" />
								...
								<div id="mck-group-create-name-sec" class="mck-group-sub-sec">
									<div id="mck-group-create-name-box"
										...
										<div class="blk-lg-12">
											<div id="mck-group-create-title" class="mck-group-create-title mck-group-title"
						...
						<div class="mck-group-icon-sec">
							<div id="mck-group-info-icon-box"
								...
								<span class="mck-overlay-box n-vis">
									...
									<div id="mck-group-info-icon-loading" class="mck-loading n-vis">
										<img src="css/app/images/mck-loading.gif" />
							...
							<div class="mck-text-center">
								<a id="mck-btn-group-icon-save" href="#" role="link"
									...
									<img
									src="css/app/images/mck-icon-save.png"
									alt="Save">
								</a>
							</div>
						</div>
				...
				<div id="mck-search-tab-box" class="mck-search-tab-box mck-row">
					<div class="blk-lg-12">
						<ul class="mck-nav mck-nav-panel">
							<li class="mck-nav-item mck-nav-divider"><a id="mck-contact-search-tab"
								class="mck-nav-link mck-contact-search active" href="#"><strong>Contacts</strong></a></li>
							<li class="mck-nav-item"><a id="mck-group-search-tab" class="mck-nav-link mck-group-search" href="#"><strong>Groups</strong></a>
							</li>
						</ul>
					</div>
				</div>
					...
					<div class="mck-form-group">
					   ...
					   <div id="mck-group-search-input-box" class="mck-input-group blk-lg-12 n-vis">
							<input id="mck-group-search-input" type="text"
								data-provide="typeahead" placeholder="Search..." autofocus /> <span
								class="mck-search-icon"><a href="#" role="link"
								class="mck-group-search-link"><span
									class="mck-icon-search"></span></a></span>
						</div>
					</div>
					<div class="mck-tab-cell">
					...
					<div class="mck-form-group">
						<div class="mck-input-group blk-lg-12">
							<input id="mck-group-member-search" type="text" data-provide="typeahead"
								...
								class="mck-search-icon"><a href="#" role="link"
								class="mck-group-member-search-link"><span class="mck-icon-search"></span></a></span>
						</div>
					</div>
					<div class="mck-tab-cell">
						<div class="mck-message-inner">
				...
				.ready(
						function() {
							...
							$applozic.fn.applozic({
										...
										userName : 'Shanki',
										imageLink :'https://scontent-sin6-1.xx.fbcdn.net/v/t1.0-9/14567979_1506780139348683_6612896422657014015_n.jpg?oh=59c5bc830e99ce302b977ce3cf50ffd7&oe=58AD3FCF',
