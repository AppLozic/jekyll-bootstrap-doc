...
<body>
							...
							<div class="mck-row">
								<div class="blk-lg-2 move-right">
									<div class="mck-dropdown-toggle" data-toggle="mckdropdown"
										aria-expanded="true">
										<img src="../images/mck-icon-menu.png" alt="Tab Menu">
									</div>
													...
													<ul id="mck-upload-menu-list"
														...
														<li><a id="mck-file-up" href="#"
															...
															title="File &amp; Photos"> <img
																src="../images/mck-icon-photo.png" class="menu-icon"
																alt="File &amp; Photos"><span>Files &amp;
																	Photos</span>
														</a></li>
				...
				<div id="mck-sidebox-search"
					...
					<div class="mck-box-top">
						...
						<div
							...
							<div class="mck-dropdown-toggle" data-toggle="mckdropdown"
								aria-expanded="true">
								<img src="../images/icon-menu.png" alt="Tab Menu">
							</div>
									...
									<div id="mck-group-create-icon-box"
										...
										<span class="mck-overlay-box">
											...
											<div id="mck-group-create-icon-loading"
												...
												<img src="../images/mck-loading.gif" alt="Loading" />
						...
						<div class="mck-group-icon-sec">
							...
							<div class="mck-text-center">
								<a id="mck-btn-group-icon-save" href="#" role="link"
									...
									<img src="../images/mck-icon-save.png" alt="Save">
								</a>
							</div>
						</div>
						...
						<div class="mck-group-md-sec">
							...
							<div id="mck-group-add-member-box"
								...
								<a id="mck-group-add-member" class="mck-group-add-member"
									href="#">
									<div class="blk-lg-3">
										<img src="../images/mck-icon-add-member.png" alt="Add Member">
									</div>
	...
	<script type="text/javascript" src="../js/applozic.socket.min.js"></script>
	<script type="text/javascript"
	...
	<script type="text/javascript" src="../js/app/applozic.common.js"></script>
	<script type="text/javascript"
		src="../js/app/sidebox/applozic.sidebox.js"></script>
	<script type="text/javascript">
		var oModal = "";
